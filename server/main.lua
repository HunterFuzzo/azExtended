...
function loadESXPlayer(identifier, playerId, isNew)
    ...
    -- xPlayer Creation
    local xPlayer = CreateExtendedPlayer(playerId, identifier, userData.ssn, userData.group, userData.accounts, userData.inventory, userData.weight, userData.loadout, GetPlayerName(playerId), userData.coords, userData.metadata)
